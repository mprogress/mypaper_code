...
def convert_train_data(file_dir):
    ...
    for files in directories:
        ...
        for file_name in file_names :
            # print(file_name)
            img = Image.open('%s'%(file_name))
            new_name = file_name.split('.')[0]
            # print(file_name)
            
            img.save('%s.jpg'%(new_name))
...
def convert_test_data(file_dir):
    ...
    root_dir = 'E:\\GTSRB_Final_Test_Images_jpg\\GTSRB\\Final_Test\\Images'
...
if __name__ == "__main__":
    train_data_dir = 'E:\\GTSRB_Final_Training_Images\\GTSRB\\Final_Training\\Images'
    # test_data_dir = 'E:\\GTSRB_Final_Test_Images\\GTSRB\\Final_Test\\Images'
